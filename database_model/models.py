...
class WeatherTimeSeries(models.Model):
    ...
    max_screen_air_temp = models.FloatField(verbose_name="Max Screen Air Temp")
    min_screen_air_temp = models.FloatField(verbose_name="Min Screen Air Temp")
    ...
    max_10m_wind_gust = models.FloatField(verbose_name="Max Wind Gust (10m)")
    ...
    total_precip_amount = models.IntegerField(verbose_name="Total Precipitation Amount")
    total_snow_amount = models.IntegerField(verbose_name="Total Snow Amount")
